...
class FrameProcessor:
    ...
    def process(self, frame):
        ...
        #print(landmarks)
        #print([(roi.image_id, roi.label, roi.confidence, roi.position, roi.size) for roi in rois])
        ...
        print([face.distance for face in face_identities])
        print(unknowns)
...
def draw_detections(frame, frame_processor, detections, output_transform):
    ...
    for roi, landmarks, identity in zip(*detections):
        ...
        xmin = max(int(roi.position[0]), 0)  # x
        ymin = max(int(roi.position[1]), 0)  # y
        ...
        # print("ROI POSITION:", roi.position)

        print(landmarks)
        print(type(landmarks))

        # point[0] = (x - roiX) / (width)
...
def main():
    ...
    while True:
        ...
        # print("ROIS:", detections[0])
        # print("Landmarks:", detections[1])
        # print("Identities:", detections[2])
